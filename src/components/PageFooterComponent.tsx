...
import { Container, Footer, Section } from 'bloomer'
      ...
      <div>
          ...
          <Container>
            <div className="has-background-light">
              <div className="has-text-centered">
                <p className="is-size-1">Find out the latest</p>
                <p id="subscribe-now">
        ...
        <Footer className="has-text-white">
          <p>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <Link className="has-text-white" to={'/workshops/'}>
              LIVE WORKSHOPS
            </Link>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <Link className="has-text-white" to={'/resources/'}>
              ONLINE RESOURCES
            </Link>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <Link className="has-text-white" to={'/faq/'}>
              SUPPORT
            </Link>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
